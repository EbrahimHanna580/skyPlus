            ...
            <div class="container" style="text-align: right;">
                ...
                <ul class="hr_list d_inline_m breadcrumbs">
                    <li class="m_right_8 f_xs_none">
                        <a href="<?php echo e(route('index')); ?>" class="color_grey_light_3 d_inline_m m_right_10">الرئيسية</a>
...
<?php echo $__env->make('layouts.normal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skyPlus\resources\views/consultingServices.blade.php ENDPATH**/ ?>