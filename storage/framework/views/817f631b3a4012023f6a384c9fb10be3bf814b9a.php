	...
	c-1.06,1.77-2.26,3.37-3.54,4.85c10.02-4.1,19.9-10.9,29.76-20.76C270.72,177.19,248.69,129.43,188.48,69.23z"/>
									...
									<nav role="navigation" class="d_inline_m d_xs_none m_xs_right_0 m_right_15 t_align_l m_xs_bottom_15">
										<ul class="hr_list main_menu fw_light">
											...
											<li class="container3d relative f_xs_none m_xs_bottom_0">
												<a class="color_dark fs_large relative r_xs_corners" href="pages_about.html">من نحن
													<i class="icon-angle-down d_inline_m"></i>
												</a>
			...
			<section class="page_title translucent_bg_color_scheme image_bg_9 image_fixed t_align_c relative wrapper">
				<div class="container" style="text-align: right;" >
					<h1 class="color_light fw_light m_bottom_5">من نحن</h1>
					<!--breadcrumbs-->
					<ul class="hr_list d_inline_m breadcrumbs">
						...
						<li class="m_right_8 f_xs_none"><a href="#" class="color_grey_light_3 d_inline_m m_right_10">من نحن</a></li>
			...
			<section class="section_offset">
				<main class="container t_align_c">
					<h3 class="color_dark fw_light m_bottom_15 heading_1">SKYPLUS</h3>
					<p class="m_bottom_35 heading_2">  استشارات  قانونية  - خدمات التامين - خدمات الترجمة  - الخدمات الجامعية </p>
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 t_align_l">
							<p class="m_bottom_15 fw_light fs_large"># </p>
							<p class="m_bottom_25 fw_light fs_large"># </p>
...
</html><?php /**PATH C:\xampp\htdocs\skyPlus\resources\views/about.blade.php ENDPATH**/ ?>