...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	<head>
		...
		<!--libs css-->
		<link rel="stylesheet" type="text/css" media="all" href="<?php echo e(asset('plugins/owl-carousel/owl.carousel.css')); ?>">
		<link rel="stylesheet" type="text/css" media="all" href="<?php echo e(asset('plugins/owl-carousel/owl.transitions.css')); ?>">
		<link rel="stylesheet" type="text/css" media="all" href="<?php echo e(asset('plugins/jackbox/css/jackbox.min.css')); ?>">
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo e(asset('plugins/rs-plugin/css/settings.css')); ?>">

		<!--theme css-->
		<link rel="stylesheet" type="text/css" media="all" href="<?php echo e(asset('css/bootstrap.min.css')); ?>">
		<link rel="stylesheet" type="text/css" media="all" href="<?php echo e(asset('css/theme-animate.css')); ?>">
		<link rel="stylesheet" type="text/css" media="all" href="<?php echo e(asset('css/style.css')); ?>">
		<link rel="stylesheet" type="text/css" media="all" href="<?php echo e(asset('css/rtl.css')); ?>">
		<!--head libs-->
		<script src="<?php echo e(asset('js/jquery-2.1.0.min.js')); ?>"></script>
		<script src="<?php echo e(asset('plugins/jquery.queryloader2.min.js')); ?>"></script>
		<script src="<?php echo e(asset('plugins/modernizr.js')); ?>"></script>
		<script>
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 t_xs_align_c">
								<ul class="hr_list fs_small color_grey_light">
									...
									<li class="m_right_20  m_xs_right_0 m_xs_bottom_5">
										<a href="tel:05385830444" class="color_grey_light d_inline_b color_black_hover"><span class="circle icon_wrap_size_1 d_inline_m m_right_8"><i class="icon-phone-1"></i></span>00905385830444</a>
									</li>
										<li class="m_right_20  m_xs_right_0 m_xs_bottom_5">
										<a href="mailto:#" class="color_grey_light d_inline_b color_black_hover"><span class="circle icon_wrap_size_1 d_inline_m m_right_8"><i class="icon-mail-alt"></i></span>info@skyplus.com.tr</a>
									</li>
								</ul>
							</div>
							<!--social icons-->
				...
				<section class="header_bottom_part bg_light">
					<div class="container">
						<div class="d_table w_full d_xs_block">
							<!--logo-->
							<div class="col-lg-2 col-md-2 col-sm-2 d_table_cell d_xs_block  v_align_m logo t_xs_align_r">

									<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 735 260" style="enable-background:new 0 0 735 260;" xml:space="preserve" width="140" >
<style type="text/css">
	.st0{fill:#282849;}
...
<g>
	<path class="st0" d="M269.88,142.09h52.92L269.88,68.6V38.71c4.11-12.89,17.55-17.82,29.89-21.39h85.82l0.27,47.16h-57.58
		l57.31,70.2V161c-3.84,17-13.98,23.03-27.42,25.77h-88.29V142.09z"/>
	<path class="st0" d="M411.09,17.6l43.6-0.55l1.92,70.2l54.84-69.37l45.52-1.1l-49.08,81.71L563,186.78l-52.92,0.55l-43.87-65.26
		l-8.23-2.74l-1.65,68h-52.92L411.09,17.6z"/>
	<path class="st0" d="M610.7,129.2L551.2,17.6l52.37-0.55l33.18,51.82l35.92-51.82l57.03-0.27l-64.71,103.65l-2.19,66.36
		l-49.36-0.55L610.7,129.2z"/>
</g>
<g>
	<path class="st0" d="M258.48,211.29h8.96c1.62,0,6.43-0.05,9.5,1.46c3.02,1.51,6.59,4.05,6.59,9.23c0,4.7-1.73,7.99-4.1,10.69
		c-2.59,1.4-7.24,2.11-11.77,2.05l-0.38,9.94h-8.86L258.48,211.29z M269.01,219.77c-1.51,1.94-2,4.7-0.05,6.53
</linearGradient>
<path class="st18" d="M188.48,69.23c-2.16-2.15-4.28-4.22-6.4-6.27c-16.9,6.43-34.33,17.74-53.63,34.78
	c5.56,4.65,11.09,9.63,16.5,15.04c47.59,48.01,56.92,92.02,57.01,92.47l0.16,0.78c2.71,11.43,0.94,24.65-4.81,34.28
	c-1.06,1.77-2.26,3.37-3.54,4.85c10.02-4.1,19.9-10.9,29.76-20.76C270.72,177.19,248.69,129.43,188.48,69.23z"/>
</svg>


							</div>
							<div class="col-lg-10 col-md-10 col-sm-10 t_align_r d_table_cell d_xs_block f_none" >
								<div class="relative clearfix t_align_l" >
									<button id="menu_button" class="r_corners tr_all color_blue db_centered m_bottom_0 d_none d_xs_block">
										<i class="icon-menu"></i>
									</button>
									<!--main navigation-->
									<nav role="navigation" class="d_inline_m d_xs_none m_xs_right_0 m_right_15 t_align_l m_xs_bottom_15">
										<ul class="hr_list main_menu fw_light">
											<li class="current container3d relative f_xs_none m_xs_bottom_0">
												<a class="color_dark fs_large relative r_xs_corners" href="<?php echo e(route('index')); ?>">الرئيسية
													<i class="icon-angle-down d_inline_m"></i>
												</a>
												<!--sub menu-->

											</li>
											<li class="container3d relative f_xs_none m_xs_bottom_0">
												<a class="color_dark fs_large relative r_xs_corners" href="<?php echo e(route('about')); ?>">من نحن
													<i class="icon-angle-down d_inline_m"></i>
												</a>

											</li>
											<li class="container3d relative f_xs_none m_xs_bottom_0">
												<a class="color_dark fs_large relative r_xs_corners" href="portfolio_classic_1_column.html">خدماتنا
											...
											<li class="container3d relative f_xs_none m_xs_bottom_0">
												<a class="color_dark fs_large relative r_xs_corners" href="<?php echo e(route('blog')); ?>">اخر الاخبار
													<i class="icon-angle-down d_inline_m"></i>
												</a>
												<!--sub menu-->
											...
											<li class="container3d relative f_xs_none m_xs_bottom_0">
												<a class="color_dark fs_large relative r_xs_corners" href="#">اتصل بنا
													<i class="icon-angle-down d_inline_m"></i>
												</a>
												<!--sub mega menu-->
								<ul class="sub_menu r_xs_corners bg_light vr_list tr_all tr_xs_none trf_xs_none bs_xs_none d_xs_none">
									<li>
										<a href="<?php echo e(route('contacti')); ?>" class="d_block color_dark relative">مكتب فرع اسطنبول</a>
									</li>
									<li>
										<a href="<?php echo e(route('contact')); ?>" class="d_block color_dark relative">مكتب فرع اورفا</a>
									</li>
			...
			<section class="relative w_full m_bottom_15">
				<div class="r_slider" style="direction: rtl;">
					<ul>
						<li data-transition="fade" data-slotamount="10" >
						   <img src="images/slide_10.jpg" alt="" data-bgfit="cover" data-bgposition="center center">
						   <div class="caption sfl str" data-x="right" data-y="120" data-speed="700"><h1 class="color_dark fw_light" style="padding-right: 10px;">SKY Plus<br>للاستشارات القانونية</h1></div>
						   <div class="caption sfl str" data-x="right" data-y="243" data-speed="700" data-start="1200" style="padding-right: 10px;">هدفنا هو الاحترافية فى تقديم الخدمات القانونية للإرتقاء بالمهنة<br>وذلك من خلال الإستعانة بأفضل الخبرات المحلية والدولية فى مختلف المجالات القانونية.</div>
						   <div class="caption sfl str" data-x="right" data-y="1000" data-speed="700" data-start="1400" style="padding-right: 10px;">
						   		<a href="#" role="button" class="tt_uppercase button_type_3 transparent color_purple r_corners fs_medium d_block tr_all">اتصل بنا</a>
						   </div>
						</li>
						<li data-transition="fade" data-slotamount="10" >
						   <img src="images/slide_11.jpg" alt="" data-bgfit="cover" data-bgposition="center center">
						   <div class="caption sfl str" data-x="right" data-y="108" data-speed="700" style="padding-right: 10px;"><h1 class="color_dark fw_light">SKY Plus<br>لخدمات الترجمة المحلفة</h1></div>
						   <div class="caption sfl str" data-x="right" data-y="243" data-speed="700" data-start="1200" style="padding-right: 10px;">منصّة واحدة لتلبية جميع احتياجاتك في الترجمة
</div>
						   <div class="caption sfl str" data-x="right" data-y="339" data-speed="700" data-start="1400">
						   		<a href="#" role="button" class="tt_uppercase button_type_3 transparent color_purple r_corners fs_medium d_block tr_all" style="padding-right: 10px;">اتصل بنا</a>
						   </div>
						</li>
						<li data-transition="fade" data-slotamount="10" >
						   <img src="images/slide_12.jpg" alt="" data-bgfit="cover" data-bgposition="center center">
						   <div class="caption sfl str" data-x="right" data-y="108" data-speed="700" style="padding-right: 10px;"><h1 class="color_dark fw_light">SKY Plus<br> لخدمات التامين</h1></div>
						   <div class="caption sfl str" data-x="right" data-y="243" data-speed="700" data-start="1200" style="padding-right: 10px;">نحن نعمل مع كافة شركات التامين في تركيا ونغطي كافة احتياجاتكم اينما كنتم</div>
						   <div class="caption sfl str" data-x="right" data-y="339" data-speed="700" data-start="1400">
						   		<a href="#" role="button" class="tt_uppercase button_type_3 transparent color_purple r_corners fs_medium d_block tr_all" style="padding-right: 10px;">اتصل بنا</a>
						   </div>
						</li>
						<li data-transition="fade" data-slotamount="10" >
						   <img src="images/slide_13.jpg" alt="" data-bgfit="cover" data-bgposition="center center">
						   <div class="caption sfl str" data-x="right" data-y="108" data-speed="700"><h1 class="color_dark fw_light" style="padding-right: 10px;" >SKY Plus<br> للخدمات الطلابية والجامعية</h1></div>
						   <div class="caption sfl str" data-x="right" data-y="243" data-speed="700" data-start="1200" style="padding-right: 10px;">خطوات بسيطة لقبولك الجامعي مع شركتنا وخدماتنا المتميزة</div>
						   <div class="caption sfl str" data-x="right" data-y="339" data-speed="700" data-start="1400">
						   		<a href="#" role="button" class="tt_uppercase button_type_3 transparent color_purple r_corners fs_medium d_block tr_all" style="padding-right: 10px;">اتصل بنا</a>
						   </div>
						</li>
			...
			<section class="section_offset">
				<div class="container t_align_c">
					<h3 class="color_dark fw_light m_bottom_15 heading_1" data-appear-animation="bounceInLeft">SKYPLUS</h3>
					<p class="m_bottom_35 heading_2" data-appear-animation="bounceInLeft" data-appear-animation-delay="150">الخدمات التي تقدمها شركتنا</p>
					<div class="tabs">
						<!--tabs nav-->
						<ul class="tabs_nav hr_list d_inline_b d_xs_block m_bottom_30 m_xs_bottom_20" data-appear-animation="bounceInLeft" data-appear-animation-delay="800">
							<li class="f_xs_none"><a href="#tab-1" class="color_dark d_block n_sc_hover">خدمات استشارية</a></li>
							<li class="f_xs_none"><a href="#tab-2" class="color_dark d_block n_sc_hover">خدمات التامين</a></li>
							<li class="f_xs_none"><a href="#tab-3" class="color_dark d_block n_sc_hover">خدمات الترجمة</a></li>
							<li class="f_xs_none"><a href="#tab-4" class="color_dark d_block n_sc_hover">خدمات جامعية</a></li>
						</ul>
						<!--tabs content-->
						<article id="tab-1">
							<div class="row">
								<div class="col-lg-6 col-md-6 m_sm_bottom_20 t_align_l fw_light">
									<p class="m_bottom_15">خدمات الاقامات في تركيا
تقدم شركتنا خدمات الاقامات في تركيا واسطنبول بالتحديد بحيث تقدم مواعيد سريعة و خدمات التجديد وضمان الحصول على الاقامات بأنواعها بتجهيز و تقديم الأوراق المناسبة بخبرة محامين و خبراء مختصين…
 </p>
									<p class="m_bottom_15">أنواع الاقامات في تركيا
<br>– الاقامة السياحية
<br>– الاقامة العقارية
<br>– اقامة الطالب
<br>– الاقامة العائلية
<br>– اقامة العمل</p>
										<a href="#" class="color_dark fs_medium color_pink_hover">اقرا المزيد
								...
								<div class="col-lg-6 col-md-6">
									<img src="images/home_img_20.jpg" class="r_corners" alt="">
								</div>
							</div>
						</article>
						<article id="tab-2">
							<div class="row">
								<div class="col-lg-6 col-md-6 m_sm_bottom_20 t_align_l fw_light">
									<p class="m_bottom_15">حلول متكاملة نقدمها لكم من اجل جميع احتياجاتكم للتأمين في تركيا ان شركتنا تعمل مع شركات التأمين التي تأتي في المقدمة في تركيا والعالم من اجل امكانية تأمين كل ما هو غالي <br>يتم خفض المخاطر الى أدني حد ممكن من الاضرار عن طريق متابعة ايام التقاعد والصحة والحياة والسيارة والمنزل من خلال حلول التامين بضمانات عالية واسعار مناسبة في شركتنا <br>اننا نسهل حياتكم من خلال خدمات المساعدة التي تقومون باختيارها الى جانب خدمات الارشاد كن معنا دائما واحصل عل كافة احتياجاتك</p>
										<a href="#" class="color_dark fs_medium color_pink_hover">اقرا المزيد
									 <span class="d_inline_m m_left_5 icon_wrap_size_0 circle color_grey_light tr_all">
									 	<i class="icon-angle-right"></i>
									 </span>
								...
								<div class="col-lg-6 col-md-6">
									<img src="images/home_img_23.jpg" class="r_corners" alt="">
								</div>
							</div>
						</article>
						<article id="tab-3">
							<div class="row">
								<div class="col-lg-6 col-md-6 m_sm_bottom_20 t_align_l fw_light">
									<p class="m_bottom_15">الترجمة الدقيقة المحلفة لكافة اللغات    <br>
- التركية <br>
- الانكليزية <br>
- الفرنسية     <br>
- الألمانية      <br>
...
- العثمانية     <br>
- الفارسية  <br>
 والمعترف بها مع تصديق من كاتب العدل في تركيا      <br>
بالإضافة لتعبئة استمارات اللجوء لجميع السفارات العالمية يدويا والكترونيا كالاسترالية والكندية والفرنسية
</p>
										<a href="#" class="color_dark fs_medium color_pink_hover">اقرا المزيد
									 <span class="d_inline_m m_left_5 icon_wrap_size_0 circle color_grey_light tr_all">
									 	<i class="icon-angle-right"></i>
								...
								<div class="col-lg-6 col-md-6">
									<img src="images/home_img_24.jpg" class="r_corners" alt="">
								</div>
							</div>
						</article>
						<article id="tab-4">
							<div class="row">
								<div class="col-lg-6 col-md-6 m_sm_bottom_20 t_align_l fw_light">
									<p class="m_bottom_15">
										نقدم في شركتنا لجميع الطلاب من كافة الجنسيات خدمات جامعية متكاملة <br>
الجامعات التركية<br> والجامعات الاوربية<br> والكثير من الخيارات التي تحدد مستقبلك <br>
نقوم بتقديم استشارات تساعدكم بتحديد خياراتكم مع فريق ذو خبرة طويلة في مجال الخدمات الجامعية
								...
								<div class="col-lg-6 col-md-6">
									<img src="images/home_img_22.jpg" class="r_corners" alt="">
								</div>
							</div>
						</article>
					</div>
                            ...
                            <figure class="t_xs_align_c col-lg-12">
                                ...
                                <div class="popup_wrap relative r_corners wrapper m_bottom_20 d_xs_inline_b d_mxs_block">
                                    ...
                                    <div class="popup_buttons tr_all_long">
                                        <a href="<?php echo e(asset($article->image)); ?>" data-group="featured_projects" data-title="Nam elit agna, endrerit sit" class="jackbox icon_wrap_size_3 color_light n_sc_hover d_block circle f_left m_right_10">
                                            <i class="icon-plus"></i>
                                        </a>
                                        <a href="<?php echo e(route('view_blog', ['id' => $article->id])); ?>" class="icon_wrap_size_3 color_light n_sc_hover d_block circle f_left">
                                            <i class="icon-link"></i>
                                        </a>
                                    </div>
                                </div>
                                <figcaption class="t_xs_align_l">
                                    <!--project's title-->
                                    <h4 class="fw_light fs_middle"><a href="#" class="color_dark" style="font-size: 16px;" ><?php echo e($article->title); ?></a></h4>
                                    <!--project's info-->
                                    <ul class="dotted_list m_bottom_5 color_grey_light_2">
                                        ...
                                        <li class="m_right_15 relative d_inline_m">
                                            <a href="#" class="fs_medium color_grey">
                                                <i><?php echo e($article->category->name); ?></i></a>,
                                            
                                        </li>
                                        
                                    </ul>
                                    <p class="m_bottom_10 fw_light"><?php echo substr($article->content, 0, 200)."....."; ?></p>
                                    <div class="clearfix">
                                        <a href="<?php echo e(route('view_blog', ['id' => $article->id])); ?>" class="color_purple color_pink_hover f_left d_block m_right_20">
                            <span class="d_inline_m m_right_5 icon_wrap_size_0 circle color_grey_light tr_all">
                                    <i class="icon-angle-right"></i>
                                </span>
                                            اقرا المزيد
                                        </a>
                                        <a href="<?php echo e(route('blog')); ?>" class="color_purple color_pink_hover f_left d_block">
                                <span class="d_inline_m m_right_5 icon_wrap_size_0 circle color_grey_light tr_all">
                                    <i class="icon-link"></i>
                                </span>
                                            آخر الاخبار
			...
			<footer role="contentinfo" class="bg_light_3" id="#footer_1">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-4 fw_light m_bottom_30">
								<h5 class="color_dark m_bottom_20">SKYPLUS</h5>
								<p>شركة استشارات قانونية وتجارية </p>
							</div>
							<!--contact info-->
							<div class="col-lg-5 col-md-5 col-sm-5 m_bottom_30">
								<h5 class="color_dark m_bottom_20 fw_light">اتصل بنا</h5>
								<div class="row">
							...
							<div class="col-lg-3 col-md-3 col-sm-3 m_bottom_30 m_xs_bottom_20">
								<h5 class="color_dark m_bottom_20 fw_light">انضم لمتابعينا</h5>
				...
				<section class="footer_bottom_part t_align_c color_grey bg_light_4 fw_light">
					<p>SKYPLUS. All Rights Reserved</p>
				</section>
			</footer>
		</div>
		<!--back to top button-->
...
<?php /**PATH D:\Laravel\skyPlus\resources\views/index.blade.php ENDPATH**/ ?>