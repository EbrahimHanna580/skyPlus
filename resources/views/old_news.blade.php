            ...
            <div class="owl-carousel" data-nav="fp_nav_" data-plugin-options='{"itemsCustom" : [[992,3],[768,2],[100,1]], "singleItem" : false}'>
                ...
                <figure class="t_xs_align_c col-lg-12">
                    ...
                    <figcaption class="t_xs_align_l">
                        <!--project's title-->
                        <h4 class="fw_light fs_middle"><a href="#" class="color_dark" style="font-size: 16px;" >دائرة الهجرة في تركيا توضح بنود القرار الجديد حول الإقامات السياحية للسوريين والأجانب</a></h4>
                        <!--project's info-->
                        ...
                        <p class="m_bottom_10 fw_light">بعد أن كثر الجـ.دل مؤخراً حول التغييرات الرسمية الجديدة بخصوص الإقامة السياحية في تركيا، أصدرت مديرية الهجرة التركية يوم أمس قراراً بخصوص تجديد الإقامات السياحية للأجانب، والشروط التي يجب أن تتوفر لأجل ذلك.</p>
                        <div class="clearfix">
                ...
                <figure class="t_xs_align_c col-lg-12">
                    ...
                    <div class="popup_wrap relative r_corners wrapper m_bottom_20 d_xs_inline_b d_mxs_block">
                        ...
                        <div class="popup_buttons tr_all_long">
                            <a href="{{asset('images/home_img_5.jpg')}}" data-group="featured_projects" data-title="Nam elit agna, endrerit sit" 
                    ...
                    <figcaption class="t_xs_align_l">
                        <!--project's title-->
                        <h4 class="fw_light fs_middle"><a href="#" class="color_dark" style="font-size: 16px;" >شروط الجنسية التركية مقابل شراء عقار في تركيا</a></h4>
                        <!--project's info-->
                        <ul class="dotted_list m_bottom_5 color_grey_light_2">
                            <li class="m_right_15 relative d_inline_m">
                                <a href="#" class="color_grey_light_2 fs_small">
                        ...
                        <p class="m_bottom_10 fw_light">صدرت مؤخرا اللائحة التنفيذية بشأن القانون الجديد لمنح الجنسية التركية مقابل استثمار عقاري بقيمة 250 ألف دولار، بدلا من مليون دولار !

تعرف معنا على جميع الشروط والتفاصيل بخصوص الإجراءات العملية للتقدم بطلب الحصول على الجنسية التركية مقابل شراء عقار.</p>
                        <div class="clearfix">
                            <a href="#" class="color_purple color_pink_hover f_left d_block m_right_20">
                                <span class="d_inline_m m_right_5 icon_wrap_size_0 circle color_grey_light tr_all">
                                    <i class="icon-angle-right"></i>
                ...
                <figure class="t_xs_align_c col-lg-12">
                    ...
                    <figcaption class="t_xs_align_l">
                        <!--project's title-->
                        <h4 class="fw_light fs_middle"><a href="#" class="color_dark" style="font-size: 16px;" >شروطوزير الداخلية التركي: إجراءات جديدة بخصوص اللاجئين السوريين.. والترحيل يقتصر على فئات محدودة</a></h4>
                        <!--project's info-->
                        <ul class="dotted_list m_bottom_5 color_grey_light_2">
                            <li class="m_right_15 relative d_inline_m">
                                <a href="#" class="color_grey_light_2 fs_small">
                        ...
                        <p class="m_bottom_10 fw_light">تحدث وزير الداخلية التركي، سليمان صويلو، السبت 13 يوليو/تموز 2019، عن أوضاع السوريين في بلاده، مؤكداً استمرار تركيا في الوقوف بجانبهم، ومشيراً إلى أن عمليات  </p>
                        <div class="clearfix">
                            <a href="#" class="color_purple color_pink_hover f_left d_block m_right_20">
                                <span class="d_inline_m m_right_5 icon_wrap_size_0 circle color_grey_light tr_all">
                                    <i class="icon-angle-right"></i>
