                                ...
                                <ul class="hr_list main_menu fw_light">
                                    ...
                                    <li class="container3d relative f_xs_none m_xs_bottom_0">
                                        ...
                                        <ul class="sub_menu r_xs_corners bg_light vr_list tr_all tr_xs_none trf_xs_none bs_xs_none d_xs_none">
                                            <li>
                                                <a href="{{route('consultingServices')}}" class="d_block color_dark relative">خدمات استشارية</a>
                                            </li>
                                            <li>
                                                <a href="{{route('contact')}}" class="d_block color_dark relative">مكتب</a>
                                            </li>

                                        </ul>
                                    </li>
                                    <li class="container3d relative f_xs_none m_xs_bottom_0">
                                        <a class="color_dark fs_large relative r_xs_corners" href="{{ route('blog') }}">اخر
                                            الاخبار
                                            <i class="icon-angle-down d_inline_m"></i>
                                        </a>
                                        <!--sub menu-->
                                    ...
                                    <li class="container3d relative f_xs_none m_xs_bottom_0">
                                        ...
                                        <ul class="sub_menu r_xs_corners bg_light vr_list tr_all tr_xs_none trf_xs_none bs_xs_none d_xs_none">
                                            <li>
                                                <a href="{{route('contacti')}}" class="d_block color_dark relative">مكتب
                                                    فرع اسطنبول</a>
                                            </li>
                                            <li>
                                                <a href="{{route('contact')}}" class="d_block color_dark relative">مكتب
                                                    فرع اورفا</a>
                                            </li>
