        ...
        c-1.06,1.77-2.26,3.37-3.54,4.85c10.02-4.1,19.9-10.9,29.76-20.76C270.72,177.19,248.69,129.43,188.48,69.23z"/>
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-10 t_align_r d_table_cell d_xs_block f_none" >
                                ...
                                <nav role="navigation" class="d_inline_m d_xs_none m_xs_right_0 m_right_15 t_align_l m_xs_bottom_15">
                                    <ul class="hr_list main_menu fw_light">
                                        <li class="current container3d relative f_xs_none m_xs_bottom_0">
                                            <a class="color_dark fs_large relative r_xs_corners" href="{{ route('index') }}">الرئيسية
                                        ...
                                        <li class="container3d relative f_xs_none m_xs_bottom_0">
                                            <a class="color_dark fs_large relative r_xs_corners" href="{{ route('about') }}">من نحن
                                                <i class="icon-angle-down d_inline_m"></i>
                                            </a>
                                        ...
                                        <li class="container3d relative f_xs_none m_xs_bottom_0">
                                            <a class="color_dark fs_large relative r_xs_corners" href="{{ route('blog') }}">اخر الاخبار
                                                <i class="icon-angle-down d_inline_m"></i>
                                            </a>
                                            <!--sub menu-->
                            ...
                            <ul class="sub_menu r_xs_corners bg_light vr_list tr_all tr_xs_none trf_xs_none bs_xs_none d_xs_none">
                                <li>
                                    <a href="{{ route('contacti') }}" class="d_block color_dark relative">مكتب فرع اسطنبول</a>
                                </li>
                                <li>
                                    <a href="{{ route('contact') }}" class="d_block color_dark relative">مكتب فرع اورفا</a>
                                </li>
